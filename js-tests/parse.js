...
//
//var p_tags = document_body.getElementsByTagName("p");
//
//for( var i = 0; i < p_tags.length; i++ )
//{
//	// Get an individual node
//	var p_node = p_tags.item(i);
//
//	var p_children = p_node.childNodes;
//
//	for( var k = 0; k < p_children.length; k++ )
//	{
//		var p_child = p_children.item(i);
//		console.debug(p_child.nodeName + "[" + i + "]" + p_child.nodeName);
//	}
//
//
//}
...
function traverseDOMTree(targetDocument, currentElement, depth)
{
  if (currentElement)
  {
	...
	{
		targetDocument.writeln("Text: "+currentElement.nodeValue);
	}
	else
	{
